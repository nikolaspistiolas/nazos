...
class AlpacaTradingInterface:
    def __init__(self, apikey = 'PK5WMENNQPTGX5RL8CRZ',
                 secretkey = '2LF5bMUVXq9xtBZRaOHwn2yVgYXCfpeayc2AItJ5'):
    ...
    def open_limit_order(self, symbol, amount, stop_loss, at_price):
        ...
        if at_price < second_price or second_price == 0:
        ...
        self.alpaca.submit_order(symbol=symbol, qty=amount, side='buy', type='limit', order_class='bracket',
                                 ...
                                 take_profit=dict(limit_price='1000000'))
